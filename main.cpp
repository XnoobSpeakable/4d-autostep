...
//ZiHEd mostly made this lol, XnoobSpeakable just a little bit of it
$hook(void, Player, updatePos, World* world, double dt)
{
	...
	glm::vec4 nextDiUpPos = nextPos + glm::vec4(0,2,0,0);
    ...
    if ( isNextBlockSolid && !isNextUpBlockSolid && !isNextDiUpBlockSolid && player.grounded ) self->pos.y += 1;
